...
def show(book_id):
    ...
    return render_template('book/show.html', book=book, book_genre=book_genre, img=img, review=review, reviews=review_arr)
...
def edit(book_id):
    ...
    if request.method == 'GET':
        ...
        for genre in selected_genres:
            list_of_genres.append(genre.genres_id)
...
def delete(book_id):
    if request.method == 'POST':
        book_genres = BookToGenre.query.filter_by(books_id=book_id).all()
