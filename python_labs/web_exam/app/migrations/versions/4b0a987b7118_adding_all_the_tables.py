...
Revision ID: 4b0a987b7118
Revises: 
Create Date: 2023-06-27 12:38:27.420660
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['user_if'], ['users.id'], name=op.f('fk_reviews_user_if_users')),
